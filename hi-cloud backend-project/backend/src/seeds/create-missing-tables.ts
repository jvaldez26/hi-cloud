...
const MISSING_TABLES = new Set([
  ...
  // Nómina Avanzada (2026-05-09)
  'nomina_novedades', 'contratos_laborales',
  // Inventarios Avanzados (2026-05-09)
  'lotes_producto', 'seriales_producto',
  // Compras Avanzadas (2026-05-09)
  'solicitudes_compra', 'solicitud_compra_lineas',
  'cotizaciones_proveedor', 'cotizacion_proveedor_lineas',
  // Atributos & Variantes de Producto (2026-05-09)
  'atributos_producto', 'valores_atributo', 'producto_variantes',
  // Planeación de la Demanda (2026-05-09)
  'planes_demanda', 'plan_demanda_lineas',
  // Manufactura Avanzada (2026-05-09)
  'centros_trabajo', 'rutas_produccion', 'etapas_ruta', 'registro_etapas_orden',
  // Proyectos Avanzados (2026-05-09)
  'presupuesto_proyecto_lineas', 'hitos_proyecto',
  // Comisiones + Cuentas Estadísticas (2026-05-09)
  'reglas_comision', 'cuentas_estadisticas', 'movimientos_estadisticos',
  // WMS (2026-05-09)
  'wms_ubicaciones', 'wms_ordenes_picking', 'wms_lineas_picking',
]);
