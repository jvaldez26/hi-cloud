...
const UNIDADES_BASE: Array<Omit<UnidadMedida, 'id'|'createdAt'|'updatedAt'|'isActive'|'empresaId'>> = [
  { codigo: 'KG',  nombre: 'Kilogramo',  simbolo: 'kg',   tipo: TipoUnidad.PESO,     activa: true, esBase: true  },
  { codigo: 'G',   nombre: 'Gramo',      simbolo: 'g',    tipo: TipoUnidad.PESO,     activa: true, esBase: false },
  { codigo: 'LB',  nombre: 'Libra',      simbolo: 'lb',   tipo: TipoUnidad.PESO,     activa: true, esBase: false },
  { codigo: 'TON', nombre: 'Tonelada',   simbolo: 't',    tipo: TipoUnidad.PESO,     activa: true, esBase: false },
  { codigo: 'L',   nombre: 'Litro',      simbolo: 'L',    tipo: TipoUnidad.VOLUMEN,  activa: true, esBase: true  },
  { codigo: 'ML',  nombre: 'Mililitro',  simbolo: 'mL',   tipo: TipoUnidad.VOLUMEN,  activa: true, esBase: false },
  { codigo: 'GAL', nombre: 'Galón',      simbolo: 'gal',  tipo: TipoUnidad.VOLUMEN,  activa: true, esBase: false },
  { codigo: 'M',   nombre: 'Metro',      simbolo: 'm',    tipo: TipoUnidad.LONGITUD, activa: true, esBase: true  },
  { codigo: 'CM',  nombre: 'Centímetro', simbolo: 'cm',   tipo: TipoUnidad.LONGITUD, activa: true, esBase: false },
  { codigo: 'MM',  nombre: 'Milímetro',  simbolo: 'mm',   tipo: TipoUnidad.LONGITUD, activa: true, esBase: false },
  { codigo: 'FT',  nombre: 'Pie',        simbolo: 'ft',   tipo: TipoUnidad.LONGITUD, activa: true, esBase: false },
  { codigo: 'PZA', nombre: 'Pieza',      simbolo: 'pza',  tipo: TipoUnidad.CANTIDAD, activa: true, esBase: true  },
  { codigo: 'DOC', nombre: 'Docena',     simbolo: 'doc',  tipo: TipoUnidad.CANTIDAD, activa: true, esBase: false },
  { codigo: 'CAJ', nombre: 'Caja',       simbolo: 'caj',  tipo: TipoUnidad.CANTIDAD, activa: true, esBase: false },
  { codigo: 'PAL', nombre: 'Palet',      simbolo: 'pal',  tipo: TipoUnidad.CANTIDAD, activa: true, esBase: false },
  { codigo: 'PAR', nombre: 'Par',        simbolo: 'par',  tipo: TipoUnidad.CANTIDAD, activa: true, esBase: false },
  { codigo: 'HR',  nombre: 'Hora',       simbolo: 'h',    tipo: TipoUnidad.TIEMPO,   activa: true, esBase: true  },
  { codigo: 'DIA', nombre: 'Día',        simbolo: 'd',    tipo: TipoUnidad.TIEMPO,   activa: true, esBase: false },
  { codigo: 'MES', nombre: 'Mes',        simbolo: 'mes',  tipo: TipoUnidad.TIEMPO,   activa: true, esBase: false },
];
