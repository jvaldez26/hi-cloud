...
const R = 58.5; // Tipo de cambio USD→DOP referencial

export const PLANES: Record<PlanTipo, PlanConfig> = {
  // ── Planes activos ─────────────────────────────────────────────────────────
  [PlanTipo.EMPRENDEDOR]: {
    nombre: 'Emprendedor', precioMensualUsd: 29,  precioAnualUsd: 313.20,
    limiteIngresosMensualesDop: 125_000,  limiteUsuarios: 2,
    diasPrueba: 15, precio: Math.round(29 * R),
    maxUsuarios: 2, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.PYME]: {
    nombre: 'Pyme', precioMensualUsd: 59, precioAnualUsd: 637.20,
    limiteIngresosMensualesDop: 500_000, limiteUsuarios: 3,
    diasPrueba: 15, precio: Math.round(59 * R),
    maxUsuarios: 3, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.PRO]: {
    nombre: 'Pro', precioMensualUsd: 89, precioAnualUsd: 961.20,
    limiteIngresosMensualesDop: 1_250_000, limiteUsuarios: 4,
    diasPrueba: 15, precio: Math.round(89 * R),
    maxUsuarios: 4, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.PLUS]: {
    nombre: 'Plus', precioMensualUsd: 129, precioAnualUsd: 1393.20,
    limiteIngresosMensualesDop: 6_250_000, limiteUsuarios: 10,
    diasPrueba: 15, precio: Math.round(129 * R),
    maxUsuarios: 10, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  // ── Legado (mantenidos para datos históricos) ──────────────────────────────
  [PlanTipo.TRIAL]: {
    nombre: 'Trial', precioMensualUsd: 0, precioAnualUsd: 0,
    limiteIngresosMensualesDop: 500_000, limiteUsuarios: -1,
    diasPrueba: 15, precio: 0,
    maxUsuarios: -1, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.BASICO]: {
    nombre: 'Básico', precioMensualUsd: 0, precioAnualUsd: 0,
    limiteIngresosMensualesDop: 125_000, limiteUsuarios: 2,
    diasPrueba: 0, precio: 1500,
    maxUsuarios: 2, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.PROFESIONAL]: {
    nombre: 'Profesional', precioMensualUsd: 0, precioAnualUsd: 0,
    limiteIngresosMensualesDop: 500_000, limiteUsuarios: 3,
    diasPrueba: 0, precio: 3500,
    maxUsuarios: 3, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.EMPRESARIAL]: {
    nombre: 'Empresarial', precioMensualUsd: 0, precioAnualUsd: 0,
    limiteIngresosMensualesDop: 1_250_000, limiteUsuarios: 10,
    diasPrueba: 0, precio: 7000,
    maxUsuarios: 10, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
  [PlanTipo.ENTERPRISE]: {
    nombre: 'Enterprise', precioMensualUsd: 0, precioAnualUsd: 0,
    limiteIngresosMensualesDop: -1, limiteUsuarios: -1,
    diasPrueba: 0, precio: 15000,
    maxUsuarios: -1, maxFacturasMes: -1, maxProductos: -1, maxClientes: -1, maxSucursales: -1,
    modulos: ['*'], soporte: '24/7',
  },
};
